...
def main():
    ...
    parser.add_argument(
        "--output-dir", type=str,
        default="/data3/huangxin/model_list/yoco-dense-3b-d_ffn-11520",
    ...
    hf_dir = output_base / "yoco-dense-3b-d_ffn-11520-hf"
    create_hf_model_dir(hf_dir, config)

    f16_dir = output_base / "yoco-dense-3b-d_ffn-11520-bitnet-f16"
    ...
    if not args.skip_i2s:
        i2s_dir = output_base / "yoco-dense-3b-d_ffn-11520-bitnet-i2s"
