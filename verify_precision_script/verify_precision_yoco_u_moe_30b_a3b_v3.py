...
This script verifies that both paths produce identical results for YOCO-U-MoE-30B-A3B-V3.
...
YOCO-U-MoE-30B-A3B-V3 has the same weight dimensions as YOCO-MoE-30B-A3B-V3
(self-decoder shares weights across T=3 iterations, but tensor shapes are identical).
"""
...
# Model dimensions from YOCO-U-MoE-30B-A3B-V3
# Same as YOCO-MoE-30B-A3B-V3 (weight sharing doesn't change tensor shapes)
DIMS = {
    "Q proj":      (8192, 3072),
    "O proj":      (3072, 4096),
...
def main():
    ...
    print("  Model: YOCO-U-MoE-30B-A3B-V3 (T=3 universal loop)")
    print("=" * 70)
    print()
    ...
    print()
    print("Note: YOCO-U shares self-decoder weights across T=3 iterations.")
    print("      Tensor shapes are identical to YOCO-MoE-30B-A3B-V3.")
    print()
